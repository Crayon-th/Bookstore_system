<template>
  ...
  export default {
      ...
      computed: {
          formattedRating() {
              return ((this.fixedPoints === null) ? this.currentRating : this.currentRating.toFixed(this.fixedPoints)) * 2
          },
          shouldRound() {
          ...
          setRating($event, persist) {
              if (!this.readOnly) {
                  ...
                  if (persist) {
                      ...
                      this.$emit('rating', this.selectedRating*2)
            ...
            //   this.$emit('rating', this.selectedRating)
          },
          resetRating() {
              if (!this.readOnly) {
