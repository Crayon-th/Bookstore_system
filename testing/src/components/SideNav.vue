<template>
  <div class="logo">
    <n-icon class="image" :size="32">
      <GitBranch/>
    </n-icon>
    <span v-if="showTitle" class="title">软件测试平台</span>
  </div>
...
import { MenuOutline, EaselSharp} from '@vicons/ionicons5'
...
.logo {
  ...
  height: 8vh;
  align-items: center;
  background-color:rgb(172, 211, 165);
}
